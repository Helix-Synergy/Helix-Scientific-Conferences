...
export const heroSlides = [
  ...
  },
  {
    ...
    button1: { text: "AI & Robotics Tracks", link: "/conferences/ai-robotics" },
    button2: { text: "Submit Your Abstract", link: "/call-for-papers" },
  },
  {
    ...
    button1: { text: "Biotech Conference Agenda", link: "/conferences/biotechnology" },
    button2: { text: "Register To Attend", link: "/buy-a-ticket" },
  },
  {
    backgroundImage: RenewableEnergySustainability,
    mainTitle: "Renewable Energy & Sustainability Summit",
    subHeading: "Pioneering Clean Energy Solutions For A Greener Planet",
    button1: { text: "Explore Energy Sessions", link: "/conferences/renewable-energy" },

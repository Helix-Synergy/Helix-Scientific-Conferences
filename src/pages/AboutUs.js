    ...
    return (
        ...
        >
            ...
            <section
                ...
                style={{ backgroundImage: `url(${AboutBanner})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundAttachment: 'fixed' }}
            >
                    ...
                    >
                        {pageData.sections.map((section, index) => (
                            <motion.div
                                key={section.id}
                                variants={itemVariants}
                                whileHover={{ scale: 1.03, boxShadow: "0 10px 20px rgba(0,0,0,0.1), 0 0 0 3px rgba(129, 140, 248, 0.3)" }}
                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <motion.p variants={itemVariants} className="text-gray-700 text-lg leading-relaxed fs-size max-h-[500px] overflow-y-auto pr-4 custom-scrollbar">
                                ...
                                <ul className="mt-8 space-y-4">
                                    {pageData.mainContent.bullets.map((bullet, index) => (
                                        ...
                                        >
                                            ...
                                            <span>
                                                {bullet.heading && <span className="font-semibold text-gray-800">{bullet.heading}</span>}{' '}
                                                {bullet.text}
                                            </span>
                                        </motion.li>
                                    ))}
...
//     return (
//         <div className="min-h-screen relative overflow-hidden text-gray-800 bg-gradient-to-br from-blue-200 via-purple-200 to-pink-200">
//             {/* Background Gradient/Blobs for uniqueness */}
...
//                 <div className="container mx-auto relative z-10 text-center px-4">
//                     <motion.h1
//                         className="text-5xl md:text-7xl font-extrabold mb-4 drop-shadow-lg text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-indigo-700"
//                         initial="hidden"
//                         animate="visible"
//                         variants={itemVariants}
//                     >
...
//             {/* <section className="py-20 text-center bg-white/30 backdrop-blur-md border-t border-white/50 mt-20">
//                 <motion.h2
//                     initial="hidden"
//                     whileInView="visible"
//                     viewport={{ once: true, threshold: 0.15 }}
...
//                     viewport={{ once: true, threshold: 0.15 }}
//                     variants={itemVariants}
//                     whileHover={{ scale: 1.1, boxShadow: "0 0 25px rgba(16, 185, 129, 0.7)" }}
//                     whileTap={{ scale: 0.95 }}

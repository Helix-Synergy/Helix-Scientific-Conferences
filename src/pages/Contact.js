                ...
                <div className="relative z-20 -mt-40 sm:-mt-52 md:-mt-80 lg:-mt-96">
                    <div className="container mx-auto px-2 sm:px-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 p-2 sm:p-6 md:p-8 rounded-xl shadow-lg backdrop-blur-sm border border-white/10 bg-gray-900/80">
                            ...
                            >
                                <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-white">Send Us a Message</h2>
                                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                                    ...
                                    {status === 'success' && (
                                        <p className="text-green-400 mt-2 sm:mt-4 text-center">Your message has been sent successfully!</p>
                                    )}
                                    {status === 'error' && (
                                        <p className="text-red-400 mt-2 sm:mt-4 text-center">Failed to send message. Please try again.</p>
                                    )}
                                </form>
                            </motion.div>
                            ...
                            >
                                <h2 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4 text-white">Contact Information</h2>

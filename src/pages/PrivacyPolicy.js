    ...
    >
      <div className="w-full max-w-4xl bg-white p-8 md:p-12 rounded-xl shadow-lg">
        ...
        <section>
          ...
          <p className="text-base leading-relaxed mb-4">
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:hello@helixconferences.com" className="text-[#3182ce] hover:underline font-medium">hello@helixconferences.com</a>.
          </p>
        </section>
      </div>
    </motion.div>

...
function Header() {
  ...
  const [isDesktopSecondaryMenuOpen, setIsDesktopSecondaryMenuOpen] =
    useState(false);
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            boxShadow:
              "0 0 10px rgba(143, 255, 105, 0.26), 0 0 20px rgb(84, 105, 8), 0 0 30px rgba(235, 138, 47, 0.45)",
            background: "#ffffff",
          }}
        ></span>
      ...
      <div className="flex items-center space-x-4 z-20">
        ...
        <div className="hidden lg:flex relative" ref={secondaryMenuRef}>
          <AnimatedHamburger
            ...
            onClick={() =>
              setIsDesktopSecondaryMenuOpen(!isDesktopSecondaryMenuOpen)
            }

...
//                      className="hover:text-white transition-colors duration-200 hover:text-shadow-white-glow"> {/* Added glow */}
//                     +17159905583
//                   </a>
//                 </p>
//                 <p className="flex items-center justify-start group">
...
//                      className="hover:text-white transition-colors duration-200 hover:text-shadow-white-glow">+1757 656 7778</a> {/* Added glow */}
//                 </p>
//                 <p className="flex items-center justify-start group">
//                   <PhoneIcon className="w-5 h-5 mr-3 text-blue-300 flex-shrink-0 animate-pulse-subtle" />
//                   <a href="tel:+919000146000" 
//                      className="hover:text-white transition-colors duration-200 hover:text-shadow-white-glow">+91 9000146000</a> {/* Added glow */}
//                 </p>
//                 <p className="flex items-center justify-start group">
//                   <EnvelopeIcon className="w-5 h-5 mr-3 text-red-300 flex-shrink-0 animate-pulse-subtle" />
...
//                 <address className="not-italic flex items-start justify-start group">
//                   <MapPinIcon className="w-5 h-5 mr-3 text-yellow-300 flex-shrink-0 mt-1 animate-pulse-subtle" />
//                   <span className="max-w-[250px] group-hover:text-shadow-white-glow transition-shadow duration-200"> {/* Added glow to span */}
//                     Helix Conferences <br />
//                     45573, Shepard Drive, Suit#101, <br />
//                     Sterling, Virginia-20164, USA
//                   </span>
...
//                       className="flex items-center justify-start hover:text-blue-400 transition-colors duration-200 relative group overflow-hidden hover:text-shadow-white-glow"
//                     >
//                       {link.icon}
//                       <span className="relative z-10">{link.name}</span>
//                       <span className="absolute bottom-0 left-0 w-full h-[2px] bg-blue-500 transform scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300 ease-out-quad"></span>
...
//                       className="group flex items-center rounded-lg transition-all duration-300 ease-in-out
//                                   hover:scale-[1.02] transform cursor-pointer justify-start hover:text-shadow-white-glow"
//                       aria-label={social.name}
//                     >
//                       <div
//                         className={`flex items-center justify-center w-8 h-8 rounded-full mr-4 shadow-md transition-all duration-300 transform group-hover:rotate-6
...
//               <p className="text-sm mb-4 hover:text-shadow-white-glow transition-shadow duration-200">Subscribe to our newsletter for the latest updates.</p>
//               <form onSubmit={handleSubscribe} className="flex flex-col w-full max-w-[180px] md:mx-0">
//                 <input
//                   type="email"
//                   placeholder="Get News & Updates"
...
//               <p className="mb-4 md:mb-0 text-center group-hover:text-shadow-white-glow transition-shadow duration-200">
//                 Copyright © {new Date().getFullYear()}{' '}
//                 <Link
//                   to="/helix-conferences"
//                   className="hover:opacity-80 transition-opacity duration-200
...
//                       className="hover:text-white transition-colors duration-200 text-center hover:text-shadow-white-glow">Terms of Use</Link> {/* Added glow */}
//                 <Link to="/privacy-policy" 
//                       className="hover:text-white transition-colors duration-200 text-center hover:text-shadow-white-glow">Privacy Policy</Link> {/* Added glow */}
//               </div>
//             </div>
//           </div>
